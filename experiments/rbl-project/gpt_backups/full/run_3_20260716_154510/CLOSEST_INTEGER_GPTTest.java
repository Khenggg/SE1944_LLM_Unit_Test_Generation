...
public class CLOSEST_INTEGER_GPTTest {
    ...
    @Test(timeout = 5000)
    public void testClosestIntegerZeroDecimal() {
        Assert.assertEquals(0, CLOSEST_INTEGER.closest_integer("0.0"));
    }

    @Test(timeout = 5000)
    public void testClosestIntegerNegativeZeroDecimal() {
        Assert.assertEquals(0, CLOSEST_INTEGER.closest_integer("-0.0"));
    }

    @Test(timeout = 5000)
    public void testClosestIntegerTrailingZeros() {
        Assert.assertEquals(16, CLOSEST_INTEGER.closest_integer("15.5000"));
        Assert.assertEquals(-16, CLOSEST_INTEGER.closest_integer("-15.5000"));
    }
    ...
    public void testClosestIntegerLargeNumber() {
        ...
        Assert.assertEquals(1000001, CLOSEST_INTEGER.closest_integer("1000000.5"));
        Assert.assertEquals(1000001, CLOSEST_INTEGER.closest_integer("1000000.6"));
    }
    ...
    @Test(timeout = 5000)
    public void testClosestIntegerNegativeSmallNumber() {
        Assert.assertEquals(-1, CLOSEST_INTEGER.closest_integer("-0.5"));
        Assert.assertEquals(0, CLOSEST_INTEGER.closest_integer("-0.4"));
    }
}