...
Before reviewing the claim-by-claim mappings, this section outlines the rationale behind the primary design decisions in the study, including the formulation of the 5 Research Questions (RQ1–RQ5) and the framing of overall test execution outcomes, with direct links to their authoritative source files:
...
- **RQ1 (Branch Coverage Threshold Attainment):** Evaluates whether zero-shot generated test suites achieve a baseline decision-path coverage threshold (30.22% branch coverage, derived from the ULT benchmark by Huang et al. 2026).
  - *Source & Code Definition:* Formally implemented in [generate_rbl4_analysis.py](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/scripts/generate_rbl4_analysis.py#L130-L135) and outputted to [summary.csv](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/results/summary.csv#L2) (row `RQ1`). Literature threshold recorded in [evidence-table-merged.md](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/docs/team-synthesis/evidence-table-merged.md) (Row 010).
- **RQ2 (Mutation Score Floor and Target Attainment):** Evaluates fault-detection effectiveness against a minimal utility floor (4.00% mutation score, derived from Wang et al. 2026 MutGen) and a benchmark target (40.21% mutation score, derived from ULT).
  - *Source & Code Definition:* Formally implemented in [generate_rbl4_analysis.py](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/scripts/generate_rbl4_analysis.py#L136-L142) and outputted to [summary.csv](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/results/summary.csv#L3-L4) (rows `RQ2_floor`, `RQ2_target`). Floor threshold recorded in [evidence-table-merged.md](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/docs/team-synthesis/evidence-table-merged.md) (Row 026).
- **RQ3 (Paired Comparison with Search-Based Baseline):** Compares executable test suites directly against retained EvoSuite baseline suites measured at 1-, 3-, and 5-minute budgets using two-sided paired Wilcoxon signed-rank tests with Holm correction.
  - *Source & Code Definition:* Formally implemented in [generate_rbl4_analysis.py](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/scripts/generate_rbl4_analysis.py#L145-L185) and outputted to [summary.csv](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/results/summary.csv#L7-L12) (rows `RQ3_1m_branch` to `RQ3_5m_mutation`). Baseline metrics loaded from [evosuite_measured_aggregate.csv](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/results/metrics/evosuite_measured_aggregate.csv).
- **RQ4 (Simultaneous Dual-Threshold Attainment):** Tests whether a majority of targets (> 50% baseline) simultaneously pass execution and satisfy both quality thresholds (Branch Coverage ≥ 30.22% and Mutation Score ≥ 4.00%).
  - *Source & Code Definition:* Formally implemented in [generate_rbl4_analysis.py](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/scripts/generate_rbl4_analysis.py#L186-L195) and outputted to [summary.csv](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/results/summary.csv#L5) (row `RQ4`). Executive summary recorded in [rbl4_final_report.md](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/results/rbl4_final_report.md#L20).
- **RQ5 (Execution Failure Pattern Analysis):** Provides a descriptive breakdown of invalid test suites, partitioning failures into compilation errors vs. runtime assertion failures.
  - *Source & Code Definition:* Formally aggregated in [generate_rbl4_analysis.py](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/scripts/generate_rbl4_analysis.py#L196-L200) from raw statuses in [full_compile_status.csv](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/results/full_compile_status.csv), outputted to [summary.csv](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/results/summary.csv#L6) (row `RQ5`).
...
- **Overall Corpus Population (N=63):** Out of 63 Java target functions evaluated, **14 suites passed execution** (22.2%) and **49 suites failed** (77.8%).
  - *Primary Source File:* Verifiable in [full_compile_status.csv](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/results/full_compile_status.csv) and validated in [rbl4_validation.md](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/results/rbl4_validation.md).
- **Primary Failure Mode (Assertion Failures):** Of the 49 invalid suites, **47 failed runtime assertions** (95.9% of invalid suites) while only **2 failed compilation** (4.1%).
  - *Primary Source File:* Derived directly from the `status` column in [full_compile_status.csv](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/results/full_compile_status.csv). This proves that the primary operational bottleneck is oracle synthesis (generating correct expected values) rather than Java syntax generation.
- **Dual-Denominator Reporting Strategy:** 
  - *Full Corpus Denominator (N=63):* All-target metrics evaluate pipeline performance without discarding failed runs. Non-executable suites retain zero coverage, producing full-corpus averages of 18.90% branch coverage and 16.21% mutation score, recorded in [gpt_class_metrics.csv](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/results/metrics/gpt_class_metrics.csv).
  - *Pass-Conditioned Subset (N=14 / N=13):* Head-to-head paired comparisons with EvoSuite (RQ3) are restricted to the 14 executable GPT suites to ensure fair metric comparison. Full reproducible calculations are executable in [full_analysis.ipynb](file:///D:/.JohanKM/Documents/Notes_for_university_backup/Semester5/SWT301/team-synthesis-final/results/full_analysis.ipynb).
