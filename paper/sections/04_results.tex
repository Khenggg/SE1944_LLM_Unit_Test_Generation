...
No RQ3 comparison was significant after Holm correction. The smallest adjusted p-value was 0.375053 for the five-minute mutation comparison. Figure~\ref{fig:paired} visualizes the paired measurements. For branch coverage, only two non-zero paired differences were ranked; this limited variation is reported directly rather than interpreted as evidence of equality.
