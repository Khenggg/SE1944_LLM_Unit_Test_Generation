...
| **IEEE003** | ⚠️ Partial | Proposes Mutation-Guided synthesis on Defects4J, but does **not** compare with human/student baselines. |
...
| **Ground Truth / Label** | ⚠️ Manageable | Student-written unit tests are already collected; requires minor clean-up (< 3 hours). |
