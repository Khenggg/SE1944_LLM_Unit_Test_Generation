...
🚀 **Setup Overleaf (PL làm ngay đầu Tuần 9)**
...
> **Nếu GV chỉ định venue cụ thể:** dùng đúng template của venue đó. Đọc Call for Papers → Author Guidelines → Download template.
...
1. Vào [overleaf.com](https://www.overleaf.com) → **New Project** → **From Template**
...
* IEEE: [ieeeauthorcenter.ieee.org](https://ieeeauthorcenter.ieee.org) → Download `IEEEtran.zip`
* ACM: [acm.org/publications/authors/submissions](https://www.acm.org/publications/authors/submissions) → Download `acmart-primary.zip`
* Springer LNCS: [springer.com/lncs](https://www.springer.com/gp/computer-science/lncs) → Download `llncs2e.zip`
...
* Tool/thư viện: `sacrebleu v2.3` for BLEU-4 hoặc `sentence-transformers` với `all-MiniLM-L6-v2`
...
> The Wilcoxon signed-rank test yields p=[value], [tên test], [effect size]=value ([mức: small/medium/large]).
...
| :--- | :---: | :---: | :---: |
| Approach A | 0.82 ± 0.09 | — | — |
| Approach B | 0.67 ± 0.12 | p=0.007 | $\delta$=0.21 (small) |
...
| **Construct** | Metric có thực sự đo đúng điều cần đo không | BLEU không capture ngữ nghĩa; CTQRS chỉ đo cấu trúc |
