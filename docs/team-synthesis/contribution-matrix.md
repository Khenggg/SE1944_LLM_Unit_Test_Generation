...
| :---: | :--- | :--- | :---: | :---: | :---: | :---: | :---: |
| **1** | **Lê Thế Khang** *(PL)* | **Project Lead & Core Systems Integrator** | **23%** | **10.0** / 10 | **9.20** / 10 | **8.05** / 10 | **6.90** / 10 |
| **2** | **Phạm An Khang** | **Research & Paper Lead Writer** | **22%** | **9.90** / 10 | **8.80** / 10 | **7.70** / 10 | **6.60** / 10 |
| **3** | **Huỳnh Cao Phước** | **EvoSuite & Environment Owner** | **19%** | **8.55** / 10 | **7.60** / 10 | **6.65** / 10 | **5.70** *(Sàn 6.0)* |
| **4** | **Đỗ Long Vỹ** | **API & Prompt Engineering Co-lead** | **18%** | **8.10** / 10 | **7.20** / 10 | **6.30** / 10 | **5.40** *(Sàn 6.0)* |
| **5** | **Nguyễn Như Ý** | **Data & Pipeline Automation Co-lead** | **18%** | **8.10** / 10 | **7.20** / 10 | **6.30** / 10 | **5.40** *(Sàn 6.0)* |
| **TỔNG**| | | **100%** | **45.0** | **40.0** | **35.0** | **30.0** |

---

## 3. Chi tiết Phân công và Mô tả Đóng góp Chuyên môn

### 3.1 Lê Thế Khang — Project Lead & Core Systems Integrator (23%)
...
### 3.2 Phạm An Khang — Research & Paper Lead Writer (22%)
...
### 3.3 Huỳnh Cao Phước — EvoSuite & Environment Owner (19%)
...
### 3.4 Đỗ Long Vỹ — API & Prompt Engineering Co-lead (18%)
...
### 3.5 Nguyễn Như Ý — Data & Pipeline Automation Co-lead (18%)
